"""Wrapper to run bgn workflow with incremental S3 uploads after each major step."""
import sys
import subprocess
import time
import os
...
print("="*70)
print("Starting BGN workflow: indices 0-9")
print("="*70)
print()

# Run the main workflow
cmd = [sys.executable, "main.py", "bgn", "0", "10"]
print(f"Executing: {' '.join(cmd)}")
print(f"Started at: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
print()

log_file = "/app/logs/bgn_0_10.log"
runtime_log_file = "/app/logs/bgn_0_10_runtime.log"
...
runtime_log.write(f"Starting BGN workflow: indices 0-9\n")
runtime_log.write("="*70 + "\n\n")
