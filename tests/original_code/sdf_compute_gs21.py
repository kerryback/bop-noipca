...
# read in grids
zgrid = np.array(pd.read_csv('GS21_solfiles/zgrid.csv', header=None)).reshape(-1)
xgrid = np.array(pd.read_csv('GS21_solfiles/xgrid.csv', header=None)).reshape(-1)
igrid = np.array(pd.read_csv('GS21_solfiles/igrid.csv', header=None)).reshape(-1)
bgrid = np.array(pd.read_csv('GS21_solfiles/bgrid.csv', header=None)).reshape(-1)
zpts = len(zgrid)
xpts = len(xgrid)
ipts = len(igrid)
bpts = len(bgrid)
...
z_cut_up = np.array(pd.read_csv('GS21_solfiles/z_cut_up.csv', header=None)).reshape(xpts, bpts)
z_cut_down = np.array(pd.read_csv('GS21_solfiles/z_cut_down.csv', header=None)).reshape(xpts, bpts)
i_cut_up = np.array(pd.read_csv('GS21_solfiles/i_cut_up.csv', header=None)).reshape(zpts, xpts, bpts)
i_cut_down = np.array(pd.read_csv('GS21_solfiles/i_cut_down.csv', header=None)).reshape(zpts, xpts, bpts)
Q_I = np.array(pd.read_csv('GS21_solfiles/Q_I.csv', header=None)).reshape(zpts, xpts, bpts)
Q_0 = np.array(pd.read_csv('GS21_solfiles/Q_0.csv', header=None)).reshape(zpts, xpts, bpts)
P_up = np.array(pd.read_csv('GS21_solfiles/P_up.csv', header=None)).reshape(zpts, xpts, bpts)
P_down = np.array(pd.read_csv('GS21_solfiles/P_down.csv', header=None)).reshape(zpts, xpts, bpts)
PI_up = np.array(pd.read_csv('GS21_solfiles/PI_up.csv', header=None)).reshape(zpts, xpts, bpts)
PI_down = np.array(pd.read_csv('GS21_solfiles/PI_down.csv', header=None)).reshape(zpts, xpts, bpts)
P0_up = np.array(pd.read_csv('GS21_solfiles/P0_up.csv', header=None)).reshape(zpts, xpts, bpts)
P0_down = np.array(pd.read_csv('GS21_solfiles/P0_down.csv', header=None)).reshape(zpts, xpts, bpts)
b_refin_0 = np.array(pd.read_csv('GS21_solfiles/b_refin_0.csv', header=None)).reshape(zpts, xpts, bpts)
b_refin_I = np.array(pd.read_csv('GS21_solfiles/b_refin_I.csv', header=None)).reshape(zpts, xpts, bpts)
...
def sdf_compute(N, T, arr_tuple):
    ...
    def sdf_loop(t, iter):
        ...
        data = {
                'iter':iter,
                'month':t,
                **{f'firm_{i+1}': val for i, val in enumerate(port[1:])}
        }
        new_row = pd.DataFrame([data])
        import os
        new_row.to_csv('port_gs.csv', mode='a', header=False, index=False)
