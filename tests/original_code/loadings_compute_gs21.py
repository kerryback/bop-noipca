...
P_up_mat = np.array(pd.read_csv('GS21_solfiles/P_up.csv', header=None)).reshape(zpts, xpts, bpts)
P_down_mat = np.array(pd.read_csv('GS21_solfiles/P_down.csv', header=None)).reshape(zpts, xpts, bpts)
